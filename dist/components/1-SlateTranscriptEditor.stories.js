...
const DEMO_MEDIA_URL_SOLEIO = 'https://anchor.fm/s/12fe0620/podcast/play/51929581/https%3A%2F%2Fd3ctxlq1ktw2nl.cloudfront.net%2Fstaging%2F2022-4-13%2Ff8968bbe-0d13-4db9-afe5-2dcca8fff92a.mp3';
const DEMO_TITLE_SOLEIO = 'Soleio Interview, PBS Frontline'; // import DEMO_SOLEIO from '../sample-data/soleio-dpe.json';

import DEMO_SOLEIO from '../sample-data/slate_transcript.json';
export const demo = () => {
  return /*#__PURE__*/React.createElement(React.Fragment, null, /*#__PURE__*/React.createElement("p", null, "Slate Transcript Editor version: ", /*#__PURE__*/React.createElement("code", null, version)), /*#__PURE__*/React.createElement(SlateTranscriptEditor, {
    mediaUrl: text('mediaUrl', DEMO_MEDIA_URL_SOLEIO),
    handleSaveEditor: action('handleSaveEditor') // handleAutoSaveChanges={action('handleAutoSaveChanges')}
...
export const optionaChildComponents = () => {
  return /*#__PURE__*/React.createElement(React.Fragment, null, /*#__PURE__*/React.createElement("p", null, "Slate Transcript Editor version: ", /*#__PURE__*/React.createElement("code", null, version)), /*#__PURE__*/React.createElement(SlateTranscriptEditor, {
    ...
    transcriptData: DEMO_SOLEIO,
    handleAnalyticsEvents: action('handleAnalyticsEvents'),
    optionalBtns: /*#__PURE__*/React.createElement(React.Fragment, null, /*#__PURE__*/React.createElement(Button, {
  ...
  }, /*#__PURE__*/React.createElement("h1", null, "Optional child component")));
};