...
import fs from 'fs';
import preSegmentText from './index.js'; // requrie on js and json is relative to current file path

import { words as sampleWords } from '../sample/words-list.sample.json'; // fs path is relative to where the node process start
...
const numberOfCharPerLine35 = 35; // TODO: not sure why Jest is having issues running this test
